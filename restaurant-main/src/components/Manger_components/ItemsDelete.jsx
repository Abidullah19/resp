...
function ItemsDelate({ getItems, setdeleteItems, id }) {
  const handledelete = async () => {
    try {
      const response = await api.delete(`delete-items/${id}`);
      console.log("checking the response of delete items", response);
      Swal.fire({
        title: 'success!',
